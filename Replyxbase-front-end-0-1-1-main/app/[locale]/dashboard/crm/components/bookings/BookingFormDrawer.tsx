                    ...
                    {!booking && customers.length > 0 && (
                        <div className="mb-4 relative">
                            <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">
                                {t("searchExisting") || "Quick Search (Optional)"}
                            </label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-[#005bbc] focus:ring-1 focus:ring-[#005bbc] outline-none transition-all text-sm"
                                />
                            </div>
                            ...
                            <AnimatePresence>
                                {showSuggestions && customerSearch.length > 0 && (
                                    <motion.div
                                        ...
                                        exit={{ opacity: 0, y: 10 }}
                                        className="absolute top-full left-0 w-full mt-1 bg-white border border-slate-100 rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto"
                                    >
                                        {customers.filter(c => 
                                        ...
                                        {customers.filter(c => 
                                            ...
                                            <div className="p-4 text-center text-sm text-slate-500">
                                                No customers found. New customer will be created.
                                            </div>
                                        )}
                                    </motion.div>
                                )}
